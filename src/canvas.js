...
class developer_key extends base {
	constructor(cache, path) {
		super(cache, `${path}/developer_key`)
	}
	update_public_jwk() {
		return new update_public_jwk(this._cache, this._path)
	}
}
...
class lti extends base {
	constructor(cache, path) {
		super(cache, `${path}/lti`)
	}
	accounts(id) {
		return new accounts(this._cache, this._path, id)
	}
	...
	developer_key() {
		return new developer_key(this._cache, this._path)
	}
	subscriptions(id) {
		return new subscriptions(this._cache, this._path, id)
	}
}
...
class sis extends base {
	constructor(cache, path) {
		super(cache, `${path}/sis`)
	}
	accounts(id) {
		return new accounts(this._cache, this._path, id)
	}
...
class subscriptions extends base {
	constructor(cache, path, id) {
		super(cache, `${path}/subscriptions`)
		if (id) this._path += `/${id}`
	}
	async post({subscription, headers} = {}) {
		const api_body = arguments[0] || {}  
		delete api_body.headers 
		return CanvasAPI.post(this._path, { method: 'POST', body: api_body, headers }, this._cache)
	}
	...
	async put({subscription, headers} = {}) {
		const api_body = arguments[0] || {}  
		delete api_body.headers 
		return CanvasAPI.put(this._path, { method: 'PUT', body: api_body, headers }, this._cache)
	}
...
class update_public_jwk extends base {
	constructor(cache, path) {
		super(cache, `${path}/update_public_jwk`)
	}
	async put({public_jwk, headers} = {}) {
		const api_body = arguments[0] || {}  
		delete api_body.headers 
		return CanvasAPI.put(this._path, { method: 'PUT', body: api_body, headers }, this._cache)
	}
